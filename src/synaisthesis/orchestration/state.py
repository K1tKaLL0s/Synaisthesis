...
EVENT_COUNCIL_REPAIR_RECORDED = "CouncilRepairRecorded"
EVENT_COUNCIL_SEMANTIC_GATE_RESOLVED = "CouncilSemanticGateResolved"
EVENT_COUNCIL_EVIDENCE_RECORDED = "CouncilEvidenceRecorded"
EVENT_COUNCIL_SLICE_CONFIRMED = "CouncilSliceConfirmed"
...
COUNCIL_STATE_EVENT_TYPES: frozenset[str] = frozenset(
    {
        ...
        EVENT_COUNCIL_REPAIR_RECORDED,
        EVENT_COUNCIL_SEMANTIC_GATE_RESOLVED,
        EVENT_COUNCIL_EVIDENCE_RECORDED,
        EVENT_COUNCIL_SLICE_CONFIRMED,
    }
)

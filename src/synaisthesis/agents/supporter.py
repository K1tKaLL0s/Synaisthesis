"""Support track agent skeleton (blueprint 04 §3 SupportTrack; M6.2).

A Supporter consumes only its own visibility bundle; it never shares context
with the Oppose or Independent tracks. Attempting to construct it from another
...
class Supporter:
    """Isolated Support track session; reads only its own bundle."""
